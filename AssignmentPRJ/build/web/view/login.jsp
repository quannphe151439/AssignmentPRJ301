                    ...
                    <div class="col-sm-8 col-sm-offset-2">
                        ...
                        <div class="wizard-container">
                            <div class="card wizard-card" data-color="red" id="wizard">
                                <form id="myform" action="login" method="POST" onsubmit ="return verifyPassword()">
                                                ...
                                                <div class="col-sm-6" >
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <div class="form-group label-floating" >
                                                            ...
                                                            <input id="clear" name="pass" type="password" class="form-control">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <div class="form-group label-floating">
                                                            ...
                                                            <input id="clear1" name="conpass" type="password" class="form-control">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-6" >
                                                    <div class="input-group">
                                                        ...
                                                        <div class="form-group label-floating" >
                                                            <label class="control-label">Username</label>
                                                            <input name="username1" type="text" class="form-control">
                                                        </div>
                                                    </div>
